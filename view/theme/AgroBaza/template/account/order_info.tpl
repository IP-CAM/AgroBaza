  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
        ...
        <table class="table table-bordered table-hover">
          <thead>
            <tr>
              ...
              <td class="text-right p_w1"><?php echo $column_quantity; ?></td>
      ...
      <div class="buttons clearfix">
          <div class="pull-left">
            <button onclick="window.print()" class="submit-btn-1 mt-20 btn-hover-1 text-right">
              Печать заказа
            </button>
          </div>
          <div class="pull-right">
           <div class="pull-right"><a href="<?php echo $continue; ?>" class="submit-btn-1 mt-20 btn-hover-1 text-right"><?php echo $button_continue; ?></a></div>
          </div>
        </div>
      </div>
      </div>
