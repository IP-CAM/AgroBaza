            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-left"><?php echo $product['isbn']; ?></td>
								<?php } ?>
								<?php if($tmdqc_cart_qty_status){ ?>
                <td class="text-center"><div class="input-group btn-block ma change-q" style="max-width: 200px;">
                    <input type="text" name="quantity[<?php echo $product['cart_id']; ?>]" value="<?php echo $product['quantity']; ?>" size="1"  />
                    <span class="input-group-btn">
                    <button type="submit" data-toggle="tooltip" title="<?php echo $button_update; ?>" class="submit-btn-1 btn-hover-1"><i class="fa fa-refresh"></i></button>
                    <button type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="submit-btn-1 btn-hover-1" onclick="cartremove('<?php echo $product['cart_id']; ?>');"><i class="fa fa-times-circle"></i></button></span></div></td>
								<?php } ?>
								<?php if($tmdqc_cart_unitprice_status){ ?>
              ...
              <tr>
                ...
                <td class="text-left"><div class="input-group btn-block" style="max-width: 200px;">
                    ...
                    <span class="input-group-btn"><button type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="submit-btn-1 mt-30 btn-hover-1" onclick="voucher.remove('<?php echo $vouchers['key']; ?>');"><i class="fa fa-times-circle"></i></button></span></div></td>
			...
			<?php if($tmdqc_cart_coupan_status){ ?>
				<div class="form-group">
						<div class="input-group">
								...
								<span class="input-group-btn">
								<input type="button" value="<?php echo $button_coupon; ?>" id="button-coupon" data-loading-text="<?php echo $text_loading; ?>"  class="submit-btn-1 mt-30 btn-hover-1" />
								</span>
						</div>
			 </div>
			 <?php } ?>
			 ...
			 <div class="form-group">
					<div class="input-group">
						...
						<span class="input-group-btn">
							<input type="submit" value="<?php echo $button_voucher; ?>" id="button-voucher" data-loading-text="<?php echo $text_loading; ?>"  class="submit-btn-1 mt-30 btn-hover-1" />
						</span>
					</div>
			 </div>
			  <?php } ?>
			 ...
			 <div class="form-group">
				 <div class="input-group">
						...
						<span class="input-group-btn">
						<input type="submit" value="<?php echo $button_reward; ?>" id="button-reward" data-loading-text="<?php echo $text_loading; ?>"  class="submit-btn-1 mt-30 btn-hover-1" />
						</span>
				 </div>
			 </div>
			 <?php } ?>
      ...
      <div class="row">
        <div class="col-sm-4 col-sm-offset-8">
          <table class="table table-bordered">
            <tr>
              <td class="text-right"><strong><?php echo $totals[2]['title']; ?>:</strong></td>
              <td class="text-right"><?php echo $totals[2]['text']; ?></td>
            </tr>
          </table>
        </div>
      </div>
