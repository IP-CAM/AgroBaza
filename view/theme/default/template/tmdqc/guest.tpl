...
function createformbysort($feild,$label,$required,$status,$alldata) {
	...
	if($feild=='tmdqc_guest_firstname'){
        ...
        <input type="text" name="firstname" value="'.$alldata['firstname'].'" placeholder="'.$label .'" id="input-payment-firstname" />
     </div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_guest_lastname'){
        ...
        <input type="text" name="lastname"  value="'.$alldata['lastname'].'" placeholder="'.$label .'" id="input-payment-lastname" /></div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_guest_telephone'){
        ...
        <input type="text" name="telephone" value="'.$alldata['telephone'].'"  placeholder="'.$label .'" id="input-payment-telephone" />
     </div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_guest_company'){
        ...
        <input type="text" name="company" value="'.$alldata['company'].'" placeholder="'.$label .'" id="input-payment-company" />
     </div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_guest_address1'){
        ...
        <input type="text" name="address_1" value="'.$alldata['address_1'].'" placeholder="'.$label .'" id="input-payment-address-1" />
     </div>';
		return $newfelid;
	}	
	...
	if($feild=='tmdqc_guest_address2'){
        ...
        <input type="text" name="address_2" value="'.$alldata['address_2'].'" placeholder="'.$label .'" id="input-payment-address-2" />
     </div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_guest_postal_code'){
        ...
        <input type="text" name="postcode" value="'.$alldata['postcode'].'" placeholder="'.$label .'" id="input-payment-postcode" />
     </div>';
		return $newfelid;
	}
	
	if($feild=='tmdqc_guest_country'){
			$newfelid =	'<div class="form-group '.$required.$status.'"><label class="control-label" for="input-payment-country">'.$label.'</label><select name="country_id" id="input-payment-country"><option value="">'. $alldata['text_select'] .'</option>';
