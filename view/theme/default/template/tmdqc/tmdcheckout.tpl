...
<div class="plr-185">
<div id="quick-checkout"  class="container-fluid">
  <ul class="breadcrumb">
...
$(document).ready(function(){
	var html = '<div id="final-button">';
			...
			html += '<a href="<?php echo $continue; ?>" class="submit-btn-1 mt-30 btn-hover-1"><?php echo $button_shopping; ?></a> <input type="button" value="<?php echo $button_order; ?>" id="tmdbuttonorder" class="submit-btn-1 mt-30 btn-hover-1" data-loading-text="<?php echo $text_loading; ?>" />';
			html += '</div>';
			html += '</div>';
			html += '</div>';
