<?php
class ControllertmdqcDir extends Controller {
	public function index() {
		...
		$data['text_opt_name'] = $this->language->get('text_opt_name');
		$data['entry_telephone'] = $this->language->get('entry_telephone');
		$data['text_dir'] = $this->language->get('text_dir');
		$data['text_send'] = $this->language->get('text_send');
		$data['text_dir_mess'] = $this->language->get('text_dir_mess');
		...
		$this->response->setOutput($this->load->view('tmdqc/dir', $data));
	}
